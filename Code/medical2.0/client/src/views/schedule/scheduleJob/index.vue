            ...
            <el-table class='drag_table' :data='scheduleJobList' border @sort-change='onSortChange' @header-dragend='onChangeWidth' :cell-class-name='cellClassName' :header-cell-class-name='headerCellClassName' highlight-current-row>
              ...
              <el-table-column label='操作' header-align='center' :width='oprColumnWidth + "px"' fixed='right'>
                <template slot='header' slot-scope="scope">
                  ...
                  <export-excel-button v-show='permission.export' :data='scheduleJobList' :tHeader='getHeads()' :filterVal='getFilterVal()' :plain='true'></export-excel-button>
                </template>
      ...
      <el-row>
        <el-col :span='24'>
          <el-pagination
            ...
            :page-sizes='[10, 20, 50, 100, scheduleJobTotal]'
            :page-size='10'
            layout='total, sizes, prev, pager, next, jumper'
            :total='scheduleJobTotal'>
          </el-pagination>
        </el-col>
      </el-row>
      <!-- 分页栏     结束 --> 
