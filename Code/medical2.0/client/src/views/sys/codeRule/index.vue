            ...
            <el-table class='drag_table' :data='codeRuleList' border @sort-change='onSortChange' @header-dragend='onChangeWidth' :cell-class-name='cellClassName' :header-cell-class-name='headerCellClassName' highlight-current-row>
              ...
              <el-table-column label='操作' header-align='center' :width='oprColumnWidth + "px"' fixed='right'>
                <template slot='header' slot-scope="scope">
                  ...
                  <export-excel-button v-show='permission.export' :data='codeRuleList' :tHeader='getHeads()' :filterVal='getFilterVal()' :plain='true'></export-excel-button>
                </template>
      ...
      <el-row>
        <el-col :span='24'>
          <el-pagination
            ...
            :page-sizes='[10, 20, 50, 100, codeRuleTotal]'
            :page-size='10'
