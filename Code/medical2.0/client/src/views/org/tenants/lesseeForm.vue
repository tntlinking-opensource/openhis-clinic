<template>
  <el-dialog :title='dialogProps.title' :visible.sync='dialogProps.visible' :close-on-click-modal='false' width='30%' 
      ...
      <div class="tab-item" v-show='tabIndex==="1"'>  
        ...
        <el-col :span='24/1'>
          <el-form-item label='租户名' prop='name' >
            <el-input :disabled='dialogProps.action === "view"' v-model='bizFormModel.name' :maxlength='100' :placeholder='dialogProps.action === "view"? "" : "请输入租户名"' autofocus></el-input>
          </el-form-item>
        </el-col>
      </el-row>
              <el-row>
        ...
        <el-col :span='24/1'>
          <el-form-item label='租户编码' prop='code' >
            <el-input :disabled='dialogProps.action === "view"' v-model='bizFormModel.code' :maxlength='100' :placeholder='dialogProps.action === "view"? "" : "请输入租户编码"' ></el-input>
          </el-form-item>
        </el-col>
      </el-row>
              <el-row>
    ...
    <span slot='footer' class='dialog-footer'>
      <el-button v-if='dialogProps.action !== "view"' :disabled="flag" type='primary' :plain='true' @click='onSubmit("lesseeForm")'>保 存</el-button>
...
import { saveTenant } from '@/api/tenant/tenant'
...
export default {
  ...
  methods: {
    ...
    doSave() {
      this.setLoad()
      saveTenant(this.bizFormModel).then(responseData => {
