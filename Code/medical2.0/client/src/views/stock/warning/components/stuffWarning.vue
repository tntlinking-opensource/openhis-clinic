        ...
        <div v-if="tabPosition=='0'">
          ...
          <el-row id="conditionOperation">
            <el-col :span="24" style="text-align:right;padding-right:5px">
                ...
                <el-button type="primary" icon="el-icon-search" @click='stuffBatchNumber' :plain='true'>搜索</el-button>
        ...
        <el-col :span="24">
          <div @mouseleave="moveTableOutside">
            ...
            <!-- show-summary
             ...
             <el-table-column prop="stuff.name" label="材料名称" > </el-table-column>
              ...
              <el-table-column prop="number" label="剩余数量" key="slot">
                  <template #default="scope">
                  {{Math.floor(scope.row.stock.surplusStock/scope.row.stuff.packNumber) >= 0 ? Math.floor(scope.row.stock.surplusStock/scope.row.stuff.packNumber)+(scope.row.stuff.packUnit.name)+((scope.row.stock.surplusStock%scope.row.stuff.packNumber > 0) ? (scope.row.stock.surplusStock%scope.row.stuff.packNumber) + scope.row.stuff.minUnit.name:""):scope.row.stock.surplusStock+scope.row.drug.stuff.packNumber}}
                </template>
                </el-table-column>
        ...
        <div v-else><el-row>
          ...
          <el-row id="conditionOperation">
            <el-col :span="24" style="text-align:right;padding-right:5px">
                ...
                <el-button type="primary" icon="el-icon-search" @click='stuffInventory' :plain='true'>搜索</el-button>
                <el-button type="info" icon="el-icon-refresh-left" @click='resetCondition' :plain='true'>重置</el-button>
            </el-col>
          </el-row>
        </div>
            ...
            <!-- show-summary
             ...
             <el-table-column prop="name" label="材料名称" > </el-table-column>
              <el-table-column prop="type.name" label="材料分类">
                 ...
                 <el-table-column prop="packNumber" label="规格" key="slot">
                   <template #default="scope">
...
export default {
  extends: MainUI,
  props:['stuffActiveName','getCurrentPage','getSizeChange'],
  data() {
    return {
       type:0,    //预警切换
       tabPosition:"0",   //预警切换
  ...
  methods: {
    ...
    exportTable(){
      if(this.tabPosition=='0'){
        ...
        this.inventorySearch.columnName = "3"
        //按库存导出
  ...
  watch: {
    ...
    getCurrentPage:function(newVal,oldVal){
      ...
      if(this.tabPosition=='0'){
        ...
        this.inventorySearch.offset = (newVal - 1) * this.inventorySearch.limit
        this.inventoryInit()
      }
    },
    tabPosition:{
