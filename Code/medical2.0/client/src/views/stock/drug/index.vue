  ...
  export default {
    ...
    data(row) {
      return {
        ...
        listApi: listDrugPage,
        getApi: getDrugById,
        deleteApi: deleteDrug,
        entityName: 'Drug',
        permissionPrefix: 'drug',
        queryTypes: {
          goods_name: "like",
          type: "=",
          bar_code: "like",
    ...
    methods: {
      ...
      SurplusStock(row) {
        ...
        return inventory(this.systemParamConfigSearch).then(responseData => {
