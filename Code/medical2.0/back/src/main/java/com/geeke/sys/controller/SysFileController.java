...
public class SysFileController extends BaseController {
    ...
    public ResponseEntity<JSONObject> bulkInsert(@RequestBody List<SysFile> entitys) {
        List<String> ids = sysFileService.bulkInsert(entitys);
        return ResponseEntity.ok(ResultUtil.successJson(ids));
    }
    
    @PostMapping(value = "bulkUpdate")
    public ResponseEntity<JSONObject> bulkUpdate(@RequestBody List<SysFile> entitys) {
        List<String> ids = sysFileService.bulkUpdate(entitys);
        return ResponseEntity.ok(ResultUtil.successJson(ids));
    }
    
    @PostMapping(value = "bulkDelete")
    public ResponseEntity<JSONObject> bulkDelete(@RequestBody List<SysFile> entitys) {
